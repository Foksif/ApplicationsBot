...
class ApplicationsBot : JavaPlugin() {
    ...
    private val buttonChannelId = ""
    private val applicationsChannelId = ""
        ...
        private fun handleActionButtons(event: ButtonInteractionEvent) {
            ...
            if (event.componentId.startsWith("approve")) {
                ...
                val embed = EmbedBuilder()
                    ...
                    .setDescription("Заявка от пользователя ${user.name} была принята.")
                    .setColor(java.awt.Color.GREEN)
                    .build()

                applicationsChannel?.sendMessageEmbeds(embed)?.queue()
                ...
                val embed = EmbedBuilder()
                    ...
                    .setDescription("Заявка от пользователя ${user.name} была отклонена.")
